---
title: "Claudeを利用して、PCNEの資格対策の学習時間を1/3以下に短縮した話"
emoji: "📝"
...
* 書かないこと:
  * PCNE の出題内容（Appendix で分類までは書きますが、内容に焦点は当てません）
...
# 結果 : 所要時間が1/3以下に
* 無事に合格して、資格を更新できました
* 従来だと実働で12時間ほど（1日3時間 × 4日）なのが、今回は **3-4時間** 程度で対策完了です
...
* 当社では BigQuery を中心としたワークロードで Google Cloud を利用することがありますので、社内で有識者が増えてくるといいな、と思ってついでに記事にしてみました！資格補助もしてもらえるので、取得しやすい環境が整っています！

# Appendix : 出題の傾向
### NCC関連
* 特定のルートだけ広報するか、特定のルートだけ除外して広報するか
* SDN製品を使っている場合の hub プロジェクトの構成方法
